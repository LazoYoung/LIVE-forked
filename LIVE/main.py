...
def parse_args():
    ...
    parser.add_argument("--experiment", type=str, default="experiment_5x1")
    parser.add_argument("--seed", type=int)
    parser.add_argument("--target", type=str, help="target image path", default="figures/smile.png")
    ...
    parser.add_argument('--signature', nargs='+', type=str, default="smile")
